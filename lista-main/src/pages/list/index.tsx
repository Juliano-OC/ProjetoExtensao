...
export default function List (){
    ...
    const renderLeftActions = () => (
        <View style={[style.Button,{backgroundColor:temas.Colors.blueLigth}]}>
            <AntDesign 
                name="edit"
                size={20}
                color={'#FFF'}
    ...
    const _renderCard = (item:PropCard,index:number) =>{        
        const color  = item.flag == 'opcional'?temas.Colors.blueLigth:temas.Colors.red
        return (
            <Swipeable  
    ...
    return(
        <View style={style.container}>
            ...
            <View style={style.header}>
                <Text style={style.greeting}>Controle de Estoque</Text>
