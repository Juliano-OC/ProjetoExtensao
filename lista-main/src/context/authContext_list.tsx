...
const flags = [
    { caption: 'em falta', color: temas.Colors.red },
    { caption: 'opcional', color: temas.Colors.blueLigth }
];
...
export const AuthProviderList = (props) => {
    ...
    const [selectedFlag, setSelectedFlag] = useState('em falta');
            ...
            >
                <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                    <View style={styles.header}>
                        ...
                        <Text style={styles.title}>{item != 0?'Editar item':'Criar item'}</Text>
